...
def buildPoints(fName):
    ...
    with open(fName) as f:
        for line in f:
            ...
            print name
            print value
            points.append(Point(name,[int(value)]))
    return points
...
def test():
    points = buildPoints("cluster_input.txt")
    # points = buildCityPoints('testpoints.txt', False)
    # print "single"
